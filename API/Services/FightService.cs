...
namespace API.Services
{
    public class FightService : IFightService
    {
        ...
        private static int DoSkillAttack(Entities.Character attacker, Entities.Character opponent, Skill skill)
        {
        ...
        public async Task<ServiceResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
        {
            ...
            try
            {
                var attacker = await _context.Characters
                    .Include(c => c.Weapon)
                    .FirstOrDefaultAsync(c => c.Id == request.AttackedId);
        ...
        private static int DoWeaponAttack(Entities.Character attacker, Entities.Character opponent)
        {
